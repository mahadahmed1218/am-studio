/*
 * AM Studios Footer
 * Design: Dark background, copyright left, social icons right, minimal
 */
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0D0D0D] text-[#FAF9F7]">
      {/* Top border */}
      <div className="h-[2px] bg-gradient-to-r from-[#CC0000] via-[#CC0000]/50 to-transparent" />
      <div className="container">
        <div className="py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <p className="text-[#888] text-xs font-body tracking-wide">
              © {year} AM Studios. All rights reserved.
            </p>
