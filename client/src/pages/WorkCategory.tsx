 ...
 * Shows full-width video(s) with context descriptions and a "Start a similar project" CTA.
 */
...
export default function WorkCategory({ params }: { params: { category: string } }) {
