 ...
 * Design: Editorial layout with numbered services, process section, pricing CTA
 */
...
const process = [
  { step: "01", title: "Discovery Call", desc: "We learn about your brand, goals, and vision in a focused 30-minute strategy session." },
  { step: "02", title: "Concept & Strategy", desc: "Our team develops a cinematic concept tailored to your brand identity and campaign objectives." },
  { step: "03", title: "Production", desc: "We execute the production using our AI-powered pipeline, maintaining film-quality standards throughout." },
  { step: "04", title: "Review & Delivery", desc: "You review the work, we refine based on feedback, and deliver final assets within 48 hours." },
];
        ...
        <div className="container">
          <div className="reveal">
            ...
            <p className="text-[#666] font-body text-lg mt-6 max-w-xl leading-relaxed">
              From concept to delivery, we offer a complete suite of cinematic production services designed for brands that refuse to look ordinary.
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="lg:col-span-5">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {service.industries.map((ind) => (
                      <span key={ind} className="font-mono-am text-[10px] text-[#888] border border-[#DDD] px-2 py-1 tracking-wider">
                        {ind}
                      </span>
                    ))}
                  </div>
        ...
        <div className="container">
          <div className="reveal mb-16">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-white max-w-lg leading-tight">
              From brief to<br />cinematic delivery.
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x divide-[#333]">
            {process.map((step, i) => (
              ...
              >
                <span className="font-mono-am text-[#CC0000] text-xs tracking-widest block mb-4">{step.step}</span>
        ...
        <div className="container">
          <div className="reveal max-w-2xl">
            ...
            <p className="text-[#666] font-body text-lg mb-8 leading-relaxed">
              Book a free 30-minute discovery call. We'll discuss your brand, your goals, and how we can create a cinematic campaign that sets you apart.
            </p>
